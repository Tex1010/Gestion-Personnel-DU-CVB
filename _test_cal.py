...
u = User.objects.create_user(username='test_emp_cal7', password='TestPass123!')
u.profile.role = employee_role
u.profile.save()

c = Client()
c.login(username='test_emp_cal7', password='TestPass123!')
...
print('banner_no_selection', 'Veuillez sélectionner un employé' in content)
