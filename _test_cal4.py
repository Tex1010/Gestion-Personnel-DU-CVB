...
admin_user = User.objects.create_user(username='test_admin_cal_final', password='TestPass123!')
admin_user.profile.role = admin_role
admin_user.profile.save()

employee_user = User.objects.create_user(username='test_emp_cal_final', password='TestPass123!')
...
req = StaffRequest.objects.create(
    ...
    reason='Test leave final'
)

c = Client()
c.login(username='test_admin_cal_final', password='TestPass123!')
...
print('contains_leave_reason', 'Test leave final' in content)
